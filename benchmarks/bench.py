...
- Baselines, same GPU, same model, same prompts:
    ...
    2) vLLM (the real bar — you will lose; quantify by how much and
...
(nanoserve / vLLM / HF), plus a TTFT-vs-load chart.
Stage 2 adds: tokens/s vs TP degree (1,2,4) with ideal-scaling line,
and a stacked bar of compute vs NCCL time per step from torch profiler.
